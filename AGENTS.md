...
- Migraciones para pegar en el SQL Editor, **en orden**: `0001_site_content.sql`, `0002_empleados_jornadas.sql` y `0003_horarios_mensuales.sql`. Guía completa (env vars, roles, horarios, jornadas, visibilidad, fallback): `docs/ADMIN.md`.
