    ...
    <div className="relative aspect-video overflow-hidden rounded-3xl border border-line bg-ink shadow-card">
      {active ? (
        <iframe
          ...
          title={`Video: ${title}`}
          /* Solo permisos que los navegadores reconocen de verdad:
             'accelerated-download' y 'web-share' provocaban avisos
             "Unrecognized feature" en la consola de Chrome. */
        ...
        >
          ...
          <span className="relative inline-flex h-20 w-20 items-center justify-center rounded-full bg-white/95 text-brand-dark shadow-card transition-transform duration-200 group-hover:scale-110">
