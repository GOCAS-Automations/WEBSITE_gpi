...
export function ValueCard({ value }: { value: CorporateValue }) {
  ...
  return (
    <div className="group relative rounded-2xl border border-line bg-white p-6 shadow-soft transition-all duration-300 hover:-translate-y-1 hover:border-brand/40 hover:shadow-card">
