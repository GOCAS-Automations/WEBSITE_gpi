/**
 * GET /admin/nomina/volante/[id]/pdf — el volante de pago, para MANAGERS.
 *
 ...
 *
 * SEGURIDAD: exige sesión de manager (`getManagerOrNull`) y, además, la
 * consulta pasa por RLS. Un 404 no revela si la liquidación existe.
 *
